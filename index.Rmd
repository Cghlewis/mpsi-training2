...
1. You will set up a series of linking key tables
  + One per entity (student key table, teacher key table, school key table)
  + This is where you will enter all of your consented participant identifiable information
    + Name, Email, DOB
  
2. You will set up a series of data collection tracking tables
  + One per entity (student tracking, teacher tracking, school tracking)
  + This is where you will track the data collected within and across time
    - Survey in wave 1, observation in wave 1, survey in wave 2, observation in wave 2

---

# Fields to include in linking key tables

  + Study ID/Location ID (Primary Key and Foreign Keys--will discuss this shortly)
...
* As you recruit participants/schools, you will add them to your linking key tables under an ID
...
# Fields to include in your tracking tables
...
# Creating your tracking tables
  ...
  + Use a system that allows querying of data (pull tables of information as needed such as rosters, or percent of surveys collected per classroom)  
...
tibble::tribble (~ stu_id, ~ stu_f_name, ~stu_l_name, ~tch_id, ~email, ~dob,
                 ...
                 26395, "Moira", "Rose", 265, "rosem@school.edu", "12/12/2005") %>%
gt::gt()
...
tibble::tribble (~ stu_id, ~ tch_id, ~t1_svy, ~t2_svy, ~t1_incent, ~t2_incent,~moved,~notes,
                 ...
                 26395, 265, "yes", "no", "yes", "no", "no", "OSS during data collection") %>%
gt::gt()
